...
const SliderCatCard = ({ className, ...props }: Props) => {
  return (
    <div
      className={`flex flex-col items-center justify-center  flex-wrap overflow-hidden mt-12 mx-3 mb-2 p-2 rounded-md text-secondary bg-white shadow-primaryShadow`}
    >
